    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              "<a class='btn btn-light dropdown-toggle" + size + "' data-toggle='dropdown' href='#'>" +
        ...
        "lists": function(locale, options) {
            ...
            return "<li>" +
              "<div class='btn-group'>" +
                "<a class='btn btn-light" + size + "' data-wysihtml5-command='insertUnorderedList' title='" + locale.lists.unordered + "' tabindex='-1'><i class='fa fa-list-ul'></i></a>" +
                "<a class='btn btn-light" + size + "' data-wysihtml5-command='insertOrderedList' title='" + locale.lists.ordered + "' tabindex='-1'><i class='fa fa-list-ol'></i></a>" +
                "<a class='btn btn-light" + size + "' data-wysihtml5-command='Outdent' title='" + locale.lists.outdent + "' tabindex='-1'><i class='fas fa-indent'></i></a>" +
                "<a class='btn btn-light" + size + "' data-wysihtml5-command='Indent' title='" + locale.lists.indent + "' tabindex='-1'><i class='fas fa-outdent'></i></a>" +
              "</div>" +
            "</li>";
        },
        ...
        "link": function(locale, options) {
            ...
            return "<li>" +
              ...
              "</div>" +
              "</div>" +
              "<a class='btn btn-light" + size + "' data-wysihtml5-command='createLink' title='" + locale.link.insert + "' tabindex='-1'><i class='fas fa-share-square'></i></a>" +
            "</li>";
        },
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
              ...
              "</div>" +
              "</div>" +
              "<a class='btn btn-light" + size + "' data-wysihtml5-command='insertImage' title='" + locale.image.insert + "' tabindex='-1'><i class='far fa-image'></i></a>" +
            "</li>";
        },
        ...
        "color": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li class='dropdown'>" +
              "<a class='btn btn-light dropdown-toggle" + size + "' data-toggle='dropdown' href='#' tabindex='-1'>" +
