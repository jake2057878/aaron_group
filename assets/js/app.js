    ...
    Sidemenu.prototype.menuItemClick = function(e) {
        ...
        if (!Hexzy_VARS.WRAPPER.hasClass("enlarged")) {
            ...
            if (!$(this).hasClass("subdrop")) {
                ...
                $("#sidebar-menu .float-end i").removeClass("mdi-minus").addClass("mdi-plus");

                // open our new menu and add the open class
                $(this).next("ul").slideDown(350);
                $(this).addClass("subdrop");
                $(".float-end i", $(this).parents(".has_sub:last")).removeClass("mdi-plus").addClass("mdi-minus");
                $(".float-end i", $(this).siblings("ul")).removeClass("mdi-minus").addClass("mdi-plus");
            } else if ($(this).hasClass("subdrop")) {
                $(this).removeClass("subdrop");
                $(this).next("ul").slideUp(350);
                $(".float-end i", $(this).parent()).removeClass("mdi-minus").addClass("mdi-plus");
            }
        }
    },
